...
namespace YEd
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("GroupNodeTypeState", Namespace="http://www.yworks.com/xml/graphml", AnonymousType=true)]
    ...
    public partial class GroupNodeTypeState
    {
        ...
        [System.Xml.Serialization.XmlAttributeAttribute("innerGraphDisplayEnabled")]
        public bool InnerGraphDisplayEnabled { get; set; }
        
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public bool InnerGraphDisplayEnabledSpecified { get; set; }
    }
}
