...
"..\..\..\..\_GitHub\XmlSchemaClassGenerator\XmlSchemaClassGenerator.Console\bin\Debug\net6.0\XmlSchemaClassGenerator.Console.exe" -o . -n http://graphml.graphdrawing.org/xmlns=GraphML -n http://www.w3.org/1999/xlink=XLink -n http://www.yworks.com/xml/graphml=YEd --nu --sf --csm=Public --ct=System.Array --dc ".\_XSD\ygraphml.xsd"